  ...
  describe('get', function () {
    describe('msg', function () {
      it('should return value from msg context', function () {
        ...
        nodeApiStub.util.getMessageProperty = sinon.stub().returns('test');
        const result = nodeRedContextService.get('msg', 'payload', message);
      ...
      it('should return undefined if message property is not found', function () {
        ...
        nodeApiStub.util.getMessageProperty = sinon.stub().returns(undefined);
        const result = nodeRedContextService.get('msg', 'topic', message);
  ...
  describe('set', function () {
    ...
    describe('msg', function () {
      ...
      it('should not set message property if message is not provided', function () {
        nodeRedContextService.set('msg', ContextLocation.Msg, 'payload');
